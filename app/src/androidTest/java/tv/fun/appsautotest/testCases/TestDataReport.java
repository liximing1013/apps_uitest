...
//        Utils.Print("play case20 ");
        Data_Play_18_FilmNewSpecial(); // 点击播放记录卡片，播放记录中有小窗口播放的专题A
        m_com.Back(2);
        m_enterPage.enterHistoryPage();
        Data_Play_18_FilmNewSpecial(); // 点击电影-新片前瞻，点击专题A开始播放
        m_com.Sleep(m_iWaitSec);
    }
